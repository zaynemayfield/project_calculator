 ...
 <div class="card" v-if="showEditMaterialForm">
    <div class="card-body">
      ...
      <div class="row align-items-center">
        ...
        <div class="col">
            <!-- PRICE FIELD -->
          <input type="number" class="form-control" min="0.00" step="0.01" id="price" name="price" placeholder="0.00"  value="" />
        </div>
        <div class="col">
...
<div class="border rounded p-3" :key="index" v-for="(lineItem, index) in lineItems">
    <!-- TOP ROW -->
        <div class="row  align-items-center mb-2">
            ...
            <!-- URL -->
            <div class="col">
                <a :href="getMaterial(lineItem.material).url" target="_blank"> {{  getMaterial(lineItem.material).url }} </a>
            </div>
            ...
            <!-- DELETE MATERIAL -->
            <div class="col">
                <button type="submit" class="btn btn-danger" @click="deleteMaterial(lineItem.material)">Delete Material</button>
            </div>
        </div>
        <!-- BOTTOM ROW -->
        <div class="row  align-items-center">
